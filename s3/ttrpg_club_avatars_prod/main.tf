# Prod counterpart to ../ttrpg_club_avatars — same shape, separate bucket/distribution.

resource "aws_s3_bucket" "avatars" {
  bucket = "ttrpg-club-avatars-prod"
...
resource "aws_cloudfront_distribution" "avatars" {
  ...
  comment     = "TTRPG club — member/GM profile pictures (public read, prod)"
