...
# isolated environment) instead of .../dev, plus this module's own prod avatars
# remote state.
...
data "template_file" "policy" {
  ...
  vars = {
    ...
    telegram_club_chat_id_param_arn = "arn:aws:ssm:${var.region}:${data.aws_caller_identity.current.account_id}:parameter/ttrpg_club/prod/telegram_club_chat_id"
  }
}
